...
import software.siani.orchilla.operators.quarter.AddQuarterTemporalOperator;
import software.siani.orchilla.operators.quarter.SubQuarterTemporalOperator;
...
public class QuarterOperatorsTest {
    ...
    public void add_two_quarters() {
        assertThat(new AddQuarterTemporalOperator(2).computeFor(event()))
    ...
    public void sub_two_quarters() {
        assertThat(new SubQuarterTemporalOperator(2).computeFor(event()))
                .isEqualTo(new TemporalTag(
