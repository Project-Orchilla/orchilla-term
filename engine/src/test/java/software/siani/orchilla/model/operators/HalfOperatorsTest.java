...
import software.siani.orchilla.model.operators.halfhour.AddHalfHourTemporalOperator;
import software.siani.orchilla.model.operators.halfhour.SubHalfHourTemporalOperator;
...
public class HalfOperatorsTest {
    ...
    public void add_two_halves_an_hour() {
        assertThat(new AddHalfHourTemporalOperator(2).computeFor(event()))
    ...
    public void sub_two_halves_an_hour() {
        assertThat(new SubHalfHourTemporalOperator(2).computeFor(event()))
                .isEqualTo(new TemporalTag(
