...
public record LastWeekdayOperator(Weekday day) implements TemporalOperator {

    @Override
    public TemporalTag computeFor(TemporalTag temporaltag) {
        LocalDateTime weekday = temporaltag.head().with(TemporalAdjusters.previous(DayOfWeek.of(day.ordinal())));
