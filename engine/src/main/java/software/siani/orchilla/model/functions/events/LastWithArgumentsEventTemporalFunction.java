...
public record LastWithArgumentsEventTemporalFunction(int value, String event, SubjectStore subjectStore) implements TemporalFunction {
    ...
    public TemporalTag computeFor(TemporalTag temporaltag) {
        ...
        if (isSet(function)) {
            ...
            if (dependence.equals("Year")) return new SubYearTemporalFunction(1).computeFor(result);
            if (dependence.equals("Month")) return new SubMonthTemporalFunction(1).computeFor(result);
            return result;
        }
